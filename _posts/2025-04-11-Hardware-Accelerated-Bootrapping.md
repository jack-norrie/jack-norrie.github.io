...
![bootstrap_adversarial](/assets/images/bootstrap_simple.png)

## Complex Statistic

Next, I looked at a more complex statistic over a more complex distribution. This time the observed coverage was far less than that promised by the nominal rate for small $n$, with all methods starting at around $\approx 70\%$. Nonetheless, all methods did eventually converge to the nominal rate as $n \rightarrow \infty$.
...
![bootstrap_adversarial](/assets/images/bootstrap_complex.png)
...
![bootstrap_adversarial](/assets/images/bootstrap_adversarial.png)
